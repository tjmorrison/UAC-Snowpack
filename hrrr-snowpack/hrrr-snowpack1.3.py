...
# serial or parallel?
# serial helpful for debugging but parallel recommended
processing = 'serial'
...
# Print out soe info
print('Running HRRR-to-Snowpack for HRRR initalized '+yr+mn+dy+hr)
print('Based on nearest neighbor HRRR grid point')
print('SLR and snowfall based on Pletcher et al. (2024) random forest')
print('Snow level based on 300 m deep transition zone below wet-bulb zero')
print('Multiple wet-bulb zero levels could cause problems as these have not been considered')
print('Outputs csv file with name hrrr_to_snowpack_yyyymmdyhr.csv')
...
# Serial process if requested
# Note: Can be helpful for debugging
